...
${OBJECTDIR}/Blink_LED.o: Blink_LED.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Blink_LED.o Blink_LED.c

${OBJECTDIR}/CntDwn_LED.o: CntDwn_LED.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CntDwn_LED.o CntDwn_LED.c
...
${OBJECTDIR}/LED_main.o: LED_main.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LED_main.o LED_main.c

${OBJECTDIR}/Multiple_LEDs.o: Multiple_LEDs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Multiple_LEDs.o Multiple_LEDs.c

${OBJECTDIR}/Out_LCD.o: Out_LCD.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Out_LCD.o Out_LCD.c

${OBJECTDIR}/PIR_Sensor.o: PIR_Sensor.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PIR_Sensor.o PIR_Sensor.c

${OBJECTDIR}/PWM_LED.o: PWM_LED.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PWM_LED.o PWM_LED.c

${OBJECTDIR}/Push_LED.o: Push_LED.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Push_LED.o Push_LED.c

${OBJECTDIR}/dht11_data.o: dht11_data.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/dht11_data.o dht11_data.c
